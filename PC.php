...
$resultGame = DB::query('
  ...
  WHERE gameInventoryIMG.IMG REGEXP \'^((?!IMG).)*$\' AND gameInventory.platForm IN (1, 6)
...
$resultConsoles = DB::query('
  ...
  WHERE consoleInventoryImg.IMG REGEXP \'^((?!IMG).)*$\' AND consoleInventory.platForm = 1
  ORDER BY RAND() LIMIT 6
');
?>
  ...
  <main role="main" style="padding-top: 83px;">
    ...
    <header class="banner">
      <img class="w-100" src="img/consoleBanner/PCIMG2.jpg" alt="Banner for XBOX">
    </header> <!-- Banner End -->
    ...
    <section class="container">
      <div class="text-left" style="padding-top: 25px;">
        <h4>Recommended PC Console Deals for you</h4>
      </div>

      <!-- PC Games Carousel 1 start-->
      ...
      <!-- PC games start carousel 1 start -->
      <!-- Recommended Games Carousel 1 start-->
      <div class="text-left" style="padding-top: 25px;">
        <h4>Recommended PC Comparable Games for you</h4>
      </div>
