...
$resultGame = DB::query('
  ...
  WHERE gameInventoryIMG.IMG REGEXP \'^((?!IMG).)*$\' AND gameInventory.platForm IN (4, 9)
...
$resultConsoles = DB::query('
  ...
  WHERE consoleInventoryImg.IMG REGEXP \'^((?!IMG).)*$\' AND consoleInventory.platForm = 4
  ORDER BY RAND() LIMIT 6
');
?>
  ...
  <main role="main" style="padding-top: 83px;">
    ...
    <header class="banner">
      <img class="w-100" src="img/consoleBanner/NintendoIMG2.jpg" alt="Banner for XBOX">
    </header> <!-- Banner End -->
    ...
    <section class="container">
      <div class="text-left" style="padding-top: 25px;">
        <h4>Recommended Nintendo Console Deals for you</h4>
      </div>

      <!-- Nintendo Games Carousel 1 start-->
      ...
      <!-- Nintendo games start carousel 1 start -->
      <!-- Recommended Games Carousel 1 start-->
      <div class="text-left" style="padding-top: 25px;">
        <h4>Recommended Nintendo Comparable Games for you</h4>
      </div>
