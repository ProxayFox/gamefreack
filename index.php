    ...
    <main role="main" style="padding-top: 83px; background-color: #d2d6dc;">
      ...
      <div class="container marketing" style="padding-top: 10px;">
        ...
        <div class="row featurette">
          ...
          <div class="col-md-5">
            <img class="featurette-image img-fluid mx-auto" src="img/Flat%20Gradient%20Social%20Media%20Icons/80/500px%20icon.png" alt="Generic placeholder image" style="height: 250px; width: 250px;">
          </div>
        </div>
