...
$resultGame = DB::query('
  ...
  WHERE gameInventoryIMG.IMG REGEXP \'^((?!IMG).)*$\' AND gameInventory.platForm IN (2, 6)
...
$resultConsoles = DB::query('
  ...
  WHERE consoleInventoryImg.IMG REGEXP \'^((?!IMG).)*$\' AND consoleInventory.platForm = 2
  ORDER BY RAND() LIMIT 6
');
?>
  ...
  <main role="main" style="padding-top: 83px;">
    ...
    <header class="banner">
      <img class="w-100" src="img/consoleBanner/XBOXIMG2.jpg" alt="Banner for XBOX">
    </header> <!-- Banner End -->
